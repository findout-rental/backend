...
# Script to test new apartment notification to admin

BASE_URL="http://localhost:8000/api"

echo "Testing New Apartment Notification..."
...
# Create a test apartment notification via tinker
echo -e "\nCreating test apartment notification..."
