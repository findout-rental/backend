...
# Script to test new user registration notification to admin
# This creates a test user registration via tinker (simulating the registration)

BASE_URL="http://localhost:8000/api"

echo "Testing New User Registration Notification..."
...
# Create a test user registration notification via tinker
echo -e "\nCreating test user registration notification..."
